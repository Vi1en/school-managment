...
// Updated backend URL - using main project's backend (v2)
const API_URL = process.env.REACT_APP_API_URL || 'https://school-g9si9j1t3-manab-mallicks-projects.vercel.app/api';
